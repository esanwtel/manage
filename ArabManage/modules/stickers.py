...
from ArabManage import BOT_USERNAME, SUDOERS, app, eor
from ArabManage.core.decorators.errors import capture_err
from ArabManage.utils.dbfunctions import del_packname, get_packname, set_packname
from ArabManage.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)
from ArabManage.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,

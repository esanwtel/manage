...
from ArabManage import BOT_ID, BOT_NAME, SUDOERS, app
...
from ArabManage.utils.http import get
from ArabManage.utils.inlinefuncs import keywords_list
...
async def global_stats(_, message):
    ...
    url = "https://api.github.com/repos/hitokizzy/Sri-Asih/contributors"
    rurl = "https://github.com/hitokizzy/Sri-Asih"
